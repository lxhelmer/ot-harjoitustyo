...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_saldon_oikein(self):
    ...
    def test_syominen_maukkaasti_eitee_negatiiviseksi(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
